          ...
          return (
            <List.Item
              ...
              accessories={[
                ...
                {
                  text: log.sleepHours
                    ? `Sleep: ${log.sleepHours.toFixed(1)}h`
                    : undefined,
                },
              ]}
              detail={
                  ...
                  metadata={
                    <List.Item.Detail.Metadata>
                      ...
                      {log.hrv !== undefined && (
                        <List.Item.Detail.Metadata.Label
                          title="HRV (rMSSD)"
                          text={`${Math.round(log.hrv)} ms`}
                        />
                      )}
                      {log.rhr !== undefined && (
                        <List.Item.Detail.Metadata.Label
                          title="Resting Heart Rate"
                          text={`${Math.round(log.rhr)} bpm`}
                        />
                      )}
                      {log.sleepHours !== undefined && (
                        <List.Item.Detail.Metadata.Label
                          title="Sleep Duration"
                          text={`${log.sleepHours.toFixed(1)} hours`}
                        />
                      )}
                      ...
                      <List.Item.Detail.Metadata.Label
                        title="Form (TSB)"
                        text={log.tsb ? String(Math.round(log.tsb)) : "N/A"}
                      />
                    </List.Item.Detail.Metadata>
                  }
                />
